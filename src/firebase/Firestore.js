...
// Recibe como parametro la order y la funcion que mostrara el alert con el id de la orden generada
export function insertDataOrder(order, funcion) {
  const ordersCollectionRef = collection(db, "orders");
  addDoc(ordersCollectionRef, order).then((doc) => {
    funcion(doc.id)
  });
}
